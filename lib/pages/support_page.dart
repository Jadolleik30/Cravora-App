  ...
  Future<void> _fetchMessages() async {
    try {
      final response = await http.get(
        Uri.parse(Config.baseUrl + "get_messages.php?user_id=${Session.userId}"),
      );
      if (mounted) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Column(
          ...
          children: [
            Text("Cravora Support", style: TextStyle(color: Colors.white, fontWeight: FontWeight.w900, fontSize: 18)),
            Row(
              children: [
                Container(width: 8, height: 8, decoration: BoxDecoration(color: Colors.green, shape: BoxShape.circle)),
                SizedBox(width: 5),
                Text("Online", style: TextStyle(color: Colors.white70, fontSize: 11, fontWeight: FontWeight.bold)),
              ],
            ),
          ],
        ),
            ...
            child: messages.isEmpty
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      bool isMe = msg['sender_id'].toString() == Session.userId.toString();
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: Icon(Icons.chat_bubble_outline_rounded, size: 60, color: Colors.red.shade100),
          ),
          SizedBox(height: 20),
          Text("How can we help?", style: TextStyle(fontSize: 20, fontWeight: FontWeight.w900)),
          SizedBox(height: 10),
          Text("Our team is here to assist you\n24 hours a day.", textAlign: TextAlign.center, style: TextStyle(color: Colors.grey, fontSize: 14)),
        ],
      ),
    );
  }
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  time,
                  style: TextStyle(fontSize: 10, color: isMe ? Colors.white70 : Colors.grey, fontWeight: FontWeight.bold),
                ),
              ],
            ),
          ),
  ...
  void _confirmClearChat() {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Text("This action cannot be undone. All messages will be permanently deleted."),
        actions: [
          ...
          TextButton(
            ...
            child: Text("Clear Everything", style: TextStyle(color: Colors.red, fontWeight: FontWeight.bold)),
          ),
        ],
      ),
    );
