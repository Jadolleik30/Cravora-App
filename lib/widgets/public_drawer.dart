      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                Text("Taste the Speed", style: TextStyle(color: Colors.white70, fontSize: 12)),
              ],
            ),
          ),
          ...
          Expanded(
            child: ListView(
              ...
              children: [
                ...
                _buildItem(context, Icons.person_add_outlined, "Create Account", '/signup'),
              ],
            ),
          ),
          ...
          Padding(
            ...
            child: Text("Join the Foodie Community", style: TextStyle(color: Colors.grey.shade400, fontSize: 12, fontWeight: FontWeight.bold)),
          ),
        ],
      ),
    );
